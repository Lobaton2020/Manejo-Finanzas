...
$configTable = [
    "use" => "custom",
    "html" => '<form method="POST" action="' . route("budget/execList/:id_temporal_budget") . '" id="form_save" />
                <button class="dropdown-item" role="button" type="submit" form="form_save"> Ejecutar presupuesto </button>
