            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card m-b-30">
                        <div class="card-body">
                            <h4 class="mt-0 header-title text-center">Editar Nota</h4>
                            <?php echo renderMessage("error") ?>
                            <form action="<?php echo route("note/update") ?>" method="POST">
                                <input type="hidden" name="id" value="<?php echo $note->id_note ?>">
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-md-6">
                                                    ...
                                                    <input onkeyup="formatPrice(event)" onload="formatPrice(event)" value="<?php echo $note->total ?>" type="text" name="total" id="total" class="form-control" required="" parsley-type="email" placeholder="ej: 2000000">
                                                </div>
                                                <script>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div>
                                                <textarea name="description" placeholder="Breve descripcion menos de 2000 letras." class="form-control" rows="4"><?php echo $note->description ?></textarea>
                                            </div>
                                        </div>
                                        <div class="form-group">
